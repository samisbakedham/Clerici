...
posted to #CLC-dev on irc.freenode.net).
...
Copyright (c) 2017-2018 The CLC Project.
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to CLC code or CLC's dependency code or CLC's potential/future dependency code or research which successfully implements CLC.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the CLC Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the CLC Maintainer Team.
